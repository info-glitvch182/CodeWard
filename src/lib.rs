...
#[derive(Debug)]
pub struct CodeWardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CodeWardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CodeWard processing");
    
    let mut processor = CodeWardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CodeWardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CodeWardProcessor::new(false);
